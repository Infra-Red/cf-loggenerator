...
*//**
 * @author  kamil.marabet on 9/23/2015.
 *
 * @see uk.me.mjt.log4jjson.SimpleJsonLayout
 */
public class CustomJsonLayout {}/*extends Layout {
    ...
    public String format(LoggingEvent le) {
        ...
        //r.put("message", this.safeToString(le.getMessage()));
        String [] messageSplitted = this.safeToString(le.getMessage()).split(",");
        r.put("batchId", Integer.valueOf(messageSplitted[0]));
        r.put("logNum", Integer.valueOf(messageSplitted[1]));
